...
#region grep-uniq-based missing SR strings.

//namespace System.IdentityModel {
	static partial class SR {


public const string AESCipherModeNotSupported = "AESCipherModeNotSupported";
public const string AESCryptAcquireContextFailed = "AESCryptAcquireContextFailed";
public const string AESCryptEncryptFailed = "AESCryptencryptFailed";
public const string AESCryptDecryptFailed = "AESCryptDecryptFailed";
public const string AESCryptImportKeyFailed = "AESCryptImportKeyFailed";
public const string AESCryptSetKeyParamFailed = "AESCryptSetKeyParamFailed";
public const string AESInsufficientOutputBuffer = "AESInsufficientOutputBuffer";
public const string AESInvalidInputBlockSize = "AESInvalidInputBlockSize";
public const string AESIVLengthNotSupported = "AESIVLengthNotSupported";
public const string AESKeyLengthNotSupported = "AESKeyLengthNotSupported";
public const string AESPaddingModeNotSupported = "AESPaddingModeNotSupported";
public const string AlgorithmAndKeyMisMatch = "AlgorithmAndKeyMisMatch";
public const string AlgorithmAndPrivateKeyMisMatch = "AlgorithmAndPrivateKeyMisMatch";
public const string AlgorithmAndPublicKeyMisMatch = "AlgorithmAndPublicKeyMisMatch";
public const string AlgorithmMismatchForTransform = "AlgorithmMismatchForTransform";
public const string ArgumentCannotBeEmptyString = "ArgumentCannotBeEmptyString";
public const string ArgumentInvalidCertificate = "ArgumentInvalidCertificate";
public const string AtLeastOneReferenceRequired = "AtLeastOneReferenceRequired";
public const string AtLeastOneTransformRequired = "AtLeastOneTransformRequired";
public const string AuthorizationContextCreated = "AuthorizationContextCreated";
public const string AuthorizationPolicyEvaluated = "AuthorizationPolicyEvaluated";
public const string CannotFindCerrt = "CannotFindCerrt";
public const string CannotValidateSecurityTokenType = "CannotValidateSecurityTokenType";
public const string CollectionWasModified = "CollectionWasModified";
public const string CountryDescription = "CountryDescription";
public const string CountryText = "CountryText";
public const string CryptoAlgorithmIsNotFipsCompliant = "CryptoAlgorithmIsNotFipsCompliant";
public const string CustomCryptoAlgorithmIsNotValidHashAlgorithm = "CustomCryptoAlgorithmIsNotValidHashAlgorithm";
public const string CustomCryptoAlgorithmIsNotValidKeyedHashAlgorithm = "CustomCryptoAlgorithmIsNotValidKeyedHashAlgorithm";
public const string CustomCryptoAlgorithmIsNotValidSymmetricAlgorithm = "CustomCryptoAlgorithmIsNotValidSymmetricAlgorithm";
public const string DateOfBirthDescription = "DateOfBirthDescription";
public const string DateOfBirthText = "DateOfBirthText";
public const string DigestVerificationFailedForReference = "DigestVerificationFailedForReference";
public const string EmailAddressDescription = "EmailAddressDescription";
public const string EmailAddressText = "EmailAddressText";
public const string EmptyOrNullArgumentString = "EmptyOrNullArgumentString";
public const string EmptyTransformChainNotSupported = "ErrorDeserializingKeyIdentifierClause";
public const string FailAcceptSecurityContext = "FailAcceptSecurityContext";
public const string FailedToDeleteKeyContainerFile = "FailedToDeleteKeyContainerFile";
public const string FailInitializeSecurityContext = "FailInitializeSecurityContext";
public const string FailLogonUser = "FailLogonUser";
...
public const string ID1006 = "ID1006";
public const string ID1007 = "ID1007";
public const string ID1008 = "ID1008";
public const string ID1009 = "ID1009";
...
public const string ID4026 = "ID4026";
...
public const string ID4292 = "ID4292";
public const string ID4294 = "ID4294";
public const string ID4296 = "ID4296";
...
public const string ID7029 = "ID7029";
...
public const string ID8025 = "ID8025";
public const string ID8026 = "ID8026";
public const string ID8027 = "ID8027";
public const string ID8028 = "ID8028";
public const string ID8029 = "ID8029";
public const string ID8030 = "ID8030";
public const string ImpersonationLevelNotSupported = "ImpersonationLevelNotSupported";
public const string InclusiveNamespacePrefixRequiresSignatureReader = "InclusiveNamespacePrefixRequiresSignatureReader";
public const string IncorrectUserNameFormat = "IncorrectUserNameFormat";
public const string InnerReaderMustBeAtElement = "InnerReaderMustBeAtElement";
public const string InvalidCustomKeyWrapAlgorithm = "InvalidCustomKeyWrapAlgorithm";
public const string InvalidHexString = "InvalidHexString";
public const string InvalidNtMapping = "InvalidNtMapping";
public const string InvalidServiceBindingInSspiNegotiationNoServiceBinding = "InvalidServiceBindingInSspiNegotiationNoServiceBinding";
public const string InvalidServiceBindingInSspiNegotiationServiceBindingNotMatched = "InvalidServiceBindingInSspiNegotiationServiceBindingNotMatched";
public const string KerberosApReqInvalidOrOutOfMemory = "KerberosApReqInvalidOrOutOfMemory";
public const string KerberosMultilegsNotSupported = "KerberosMultilegsNotSupported";
public const string KeyIdentifierCannotCreateKey = "KeyIdentifierCannotCreateKey";
public const string KeyIdentifierClauseDoesNotSupportKeyCreation = "KeyIdentifierClauseDoesNotSupportKeyCreation";
public const string LengthMustBeGreaterThanZero = "LengthMustBeGreaterThanZero";
public const string LengthOfArrayToConvertMustGreaterThanZero = "LengthOfArrayToConvertMustGreaterThanZero";
public const string LocalIdCannotBeEmpty = "LocalIdCannotBeEmpty";
public const string LocalityDescription = "LocalityDescription";
public const string LocalityText = "LocalityText";
public const string MissingPrivateKey = "MissingPrivateKey";
...
public const string NoInputIsSetForCanonicalization = "NoInputIsSetForCanonicalization";
public const string NoKeyIdentifierClauseFound = "NoKeyIdentifierClauseFound";
public const string NoPrivateKeyAvailable = "NoPrivateKeyAvailable";
...
public const string PrivateKeyExchangeNotSupported = "PrivateKeyExchangeNotSupported";
public const string PrivateKeyNotDSA = "PrivateKeyNotDSA";
public const string PrivateKeyNotRSA = "PrivateKeyNotRSA";
public const string ProvidedNetworkCredentialsForKerberosHasInvalidUserName = "ProvidedNetworkCredentialsForKerberosHasInvalidUserName";
public const string PublicKeyNotDSA = "PublicKeyNotDSA";
public const string RequiredTargetNotSigned = "RequiredTargetNotSigned";
public const string RoleDescription = "RoleDescription";
public const string RoleText = "RoleText";
public const string SAMLActionNameRequired = "SAMLActionNameRequired";
public const string SAMLActionNameRequiredOnRead = "SAMLActionNameRequiredOnRead";
public const string SAMLAssertionIDIsInvalid = "SAMLAssertionIDIsInvalid";
public const string SAMLAssertionIdRequired = "SAMLAssertionIdRequired";
public const string SAMLAssertionIssuerRequired = "SAMLAssertionIssuerRequired";
public const string SAMLAssertionMissingIssuerAttributeOnRead = "SAMLAssertionMissingIssuerAttributeOnRead";
public const string SAMLAssertionMissingMajorVersionAttributeOnRead = "SAMLAssertionMissingMajorVersionAttributeOnRead";
public const string SAMLAssertionMissingMinorVersionAttributeOnRead = "SAMLAssertionMissingMinorVersionAttributeOnRead";
public const string SamlAssertionMissingSigningCredentials = "SamlAssertionMissingSigningCredentials";
public const string SAMLAssertionRequireOneStatement = "SAMLAssertionRequireOneStatement";
public const string SAMLAssertionRequireOneStatementOnRead = "SAMLAssertionRequireOneStatementOnRead";
public const string SamlAttributeClaimResourceShouldBeAString = "SamlAttributeClaimResourceShouldBeAString";
public const string SamlAttributeClaimRightShouldBePossessProperty = "SamlAttributeClaimRightShouldBePossessProperty";
public const string SAMLAttributeMissingNameAttributeOnRead = "SAMLAttributeMissingNameAttributeOnRead";
public const string SAMLAttributeMissingNamespaceAttributeOnRead = "SAMLAttributeMissingNamespaceAttributeOnRead";
public const string SAMLAttributeNameAttributeRequired = "SAMLAttributeNameAttributeRequired";
public const string SAMLAttributeNamespaceAttributeRequired = "SAMLAttributeNamespaceAttributeRequired";
public const string SAMLAttributeShouldHaveOneValue = "SAMLAttributeShouldHaveOneValue";
public const string SAMLAttributeStatementMissingAttributeOnRead = "SAMLAttributeStatementMissingAttributeOnRead";
public const string SAMLAttributeStatementMissingSubjectOnRead = "SAMLAttributeStatementMissingSubjectOnRead";
public const string SAMLAttributeValueCannotBeNull = "SAMLAttributeValueCannotBeNull";
public const string SAMLAudienceRestrictionInvalidAudienceValueOnRead = "SAMLAudienceRestrictionInvalidAudienceValueOnRead";
public const string SAMLAudienceRestrictionShouldHaveOneAudience = "SAMLAudienceRestrictionShouldHaveOneAudience";
public const string SAMLAudienceRestrictionShouldHaveOneAudienceOnRead = "SAMLAudienceRestrictionShouldHaveOneAudienceOnRead";
public const string SAMLAudienceUrisNotFound = "SAMLAudienceUrisNotFound";
public const string SAMLAudienceUriValidationFailed = "SAMLAudienceUriValidationFailed";
public const string SAMLAuthenticationStatementMissingAuthenticationInstanceOnRead = "SAMLAuthenticationStatementMissingAuthenticationInstanceOnRead";
public const string SAMLAuthenticationStatementMissingAuthenticationMethod = "SAMLAuthenticationStatementMissingAuthenticationMethod";
public const string SAMLAuthenticationStatementMissingAuthenticationMethodOnRead = "SAMLAuthenticationStatementMissingAuthenticationMethodOnRead";
public const string SAMLAuthenticationStatementMissingSubject = "SAMLAuthenticationStatementMissingSubject";
public const string SAMLAuthorityBindingInvalidAuthorityKind = "SAMLAuthorityBindingInvalidAuthorityKind";
public const string SAMLAuthorityBindingMissingAuthorityKind = "SAMLAuthorityBindingMissingAuthorityKind";
public const string SAMLAuthorityBindingMissingAuthorityKindOnRead = "SAMLAuthorityBindingMissingAuthorityKindOnRead";
public const string SAMLAuthorityBindingMissingBindingOnRead = "SAMLAuthorityBindingMissingBindingOnRead";
public const string SAMLAuthorityBindingMissingLocationOnRead = "SAMLAuthorityBindingMissingLocationOnRead";
public const string SAMLAuthorityBindingRequiresBinding = "SAMLAuthorityBindingRequiresBinding";
public const string SAMLAuthorityBindingRequiresLocation = "SAMLAuthorityBindingRequiresLocation";
public const string SAMLAuthorityKindMissingName = "SAMLAuthorityKindMissingName";
public const string SAMLAuthorizationDecisionHasMoreThanOneEvidence = "SAMLAuthorizationDecisionHasMoreThanOneEvidence";
public const string SAMLAuthorizationDecisionResourceRequired = "SAMLAuthorizationDecisionResourceRequired";
public const string SAMLAuthorizationDecisionShouldHaveOneAction = "SAMLAuthorizationDecisionShouldHaveOneAction";
public const string SAMLAuthorizationDecisionShouldHaveOneActionOnRead = "SAMLAuthorizationDecisionShouldHaveOneActionOnRead";
public const string SAMLAuthorizationDecisionStatementMissingDecisionAttributeOnRead = "SAMLAuthorizationDecisionStatementMissingDecisionAttributeOnRead";
public const string SAMLAuthorizationDecisionStatementMissingResourceAttributeOnRead = "SAMLAuthorizationDecisionStatementMissingResourceAttributeOnRead";
public const string SAMLAuthorizationDecisionStatementMissingSubjectOnRead = "SAMLAuthorizationDecisionStatementMissingSubjectOnRead";
public const string SAMLBadSchema = "SAMLBadSchema";
public const string SAMLElementNotRecognized = "SAMLElementNotRecognized";
public const string SAMLEntityCannotBeNullOrEmpty = "SAMLEntityCannotBeNullOrEmpty";
public const string SAMLEvidenceShouldHaveOneAssertion = "SAMLEvidenceShouldHaveOneAssertion";
public const string SAMLEvidenceShouldHaveOneAssertionOnRead = "SAMLEvidenceShouldHaveOneAssertionOnRead";
public const string SamlInvalidSigningToken = "SamlInvalidSigningToken";
public const string SAMLNameIdentifierMissingIdentifierValueOnRead = "SAMLNameIdentifierMissingIdentifierValueOnRead";
public const string SamlSerializerRequiresExternalSerializers = "SamlSerializerRequiresExternalSerializers";
public const string SamlSerializerUnableToReadSecurityKeyIdentifier = "SamlSerializerUnableToReadSecurityKeyIdentifier";
public const string SamlSerializerUnableToWriteSecurityKeyIdentifier = "SamlSerializerUnableToWriteSecurityKeyIdentifier";
public const string SAMLSignatureAlreadyRead = "SAMLSignatureAlreadyRead";
public const string SamlSigningTokenMissing = "SamlSigningTokenMissing";
public const string SamlSigningTokenNotFound = "SamlSigningTokenNotFound";
public const string SAMLSubjectConfirmationClauseMissingConfirmationMethodOnRead = "SAMLSubjectConfirmationClauseMissingConfirmationMethodOnRead";
public const string SAMLSubjectNameIdentifierRequiresNameValue = "SAMLSubjectNameIdentifierRequiresNameValue";
public const string SAMLSubjectRequiresConfirmationMethodWhenConfirmationDataOrKeyInfoIsSpecified = "SAMLSubjectRequiresConfirmationMethodWhenConfirmationDataOrKeyInfoIsSpecified";
public const string SAMLSubjectRequiresNameIdentifierOrConfirmationMethod = "SAMLSubjectRequiresNameIdentifierOrConfirmationMethod";
public const string SAMLSubjectRequiresNameIdentifierOrConfirmationMethodOnRead = "SAMLSubjectRequiresNameIdentifierOrConfirmationMethodOnRead";
public const string SAMLSubjectStatementRequiresSubject = "SAMLSubjectStatementRequiresSubject";
public const string SamlTokenAuthenticatorCanOnlyProcessSamlTokens = "SamlTokenAuthenticatorCanOnlyProcessSamlTokens";
public const string SamlTokenMissingSignature = "SamlTokenMissingSignature";
public const string SAMLTokenNotSerialized = "SAMLTokenNotSerialized";
public const string SAMLTokenTimeInvalid = "SAMLTokenTimeInvalid";
public const string SAMLTokenVersionNotSupported = "SAMLTokenVersionNotSupported";
public const string SamlUnableToExtractSubjectKey = "SamlUnableToExtractSubjectKey";
public const string SAMLUnableToLoadAdvice = "SAMLUnableToLoadAdvice";
public const string SAMLUnableToLoadAssertion = "SAMLUnableToLoadAssertion";
public const string SAMLUnableToLoadAttribute = "SAMLUnableToLoadAttribute";
public const string SAMLUnableToLoadCondtion = "SAMLUnableToLoadCondtion";
public const string SAMLUnableToLoadCondtions = "SAMLUnableToLoadCondtions";
public const string SAMLUnableToLoadStatement = "SAMLUnableToLoadStatement";
public const string SAMLUnableToLoadUnknownElement = "SAMLUnableToLoadUnknownElement";
public const string SAMLUnableToResolveSignatureKey = "SAMLUnableToResolveSignatureKey";
public const string SecurityChannelBindingMissing = "SecurityChannelBindingMissing";
public const string SecurityTokenRequirementDoesNotContainProperty = "SecurityTokenRequirementDoesNotContainProperty";
public const string SecurityTokenRequirementHasInvalidTypeForProperty = "SecurityTokenRequirementHasInvalidTypeForProperty";
public const string ServiceNameFromClient = "ServiceNameFromClient";
public const string ServiceNameOnService = "ServiceNameOnService";
public const string SspiLoginPromptHeaderMessage = "SspiLoginPromptHeaderMessage";
public const string SSPIPackageNotSupported = "SSPIPackageNotSupported";
public const string SspiPayloadNotEncrypted = "SspiPayloadNotEncrypted";
public const string SspiWrapperEncryptDecryptAssert1 = "SspiWrapperEncryptDecryptAssert1";
public const string SspiWrapperEncryptDecryptAssert2 = "SspiWrapperEncryptDecryptAssert2";
...
public const string SymmetricKeyLengthTooShort = "SymmetricKeyLengthTooShort";
public const string TokenCancellationNotSupported = "TokenCancellationNotSupported";
public const string TokenProviderUnableToGetToken = "TokenProviderUnableToGetToken";
public const string TokenProviderUnableToRenewToken = "TokenProviderUnableToRenewToken";
public const string TokenRenewalNotSupported = "TokenRenewalNotSupported";
public const string TraceCodeChannelBindingCheck = "TraceCodeChannelBindingCheck";
public const string TraceCodeIdentityModel = "TraceCodeIdentityModel";
public const string TraceCodeServiceBindingCheck = "TraceCodeServiceBindingCheck";
public const string TraceDeflateCookieEncode = "TraceDeflateCookieEncode";
...
public const string UnableToCreateHashAlgorithmFromAsymmetricCrypto = "UnableToCreateHashAlgorithmFromAsymmetricCrypto";
public const string UnableToCreateKerberosCredentials = "UnableToCreateKerberosCredentials";
public const string UnableToCreateKeyedHashAlgorithm = "UnableToCreateKeyedHashAlgorithm";
public const string UnableToCreateKeyedHashAlgorithmFromSymmetricCrypto = "UnableToCreateKeyedHashAlgorithmFromSymmetricCrypto";
public const string UnableToCreateSignatureDeformatterFromAsymmetricCrypto = "UnableToCreateSignatureDeformatterFromAsymmetricCrypto";
public const string UnableToCreateSignatureFormatterFromAsymmetricCrypto = "UnableToCreateSignatureFormatterFromAsymmetricCrypto";
public const string UnableToResolveKeyReference = "UnableToResolveKeyReference";
public const string UnableToResolveTokenReference = "UnableToResolveTokenReference";
public const string UnsupportedAlgorithmForCryptoOperation = "UnsupportedAlgorithmForCryptoOperation";
public const string UnsupportedEncryptionAlgorithm = "UnsupportedEncryptionAlgorithm";
public const string UnsupportedInputTypeForTransform = "UnsupportedInputTypeForTransform";
public const string UnsupportedKeyWrapAlgorithm = "UnsupportedKeyWrapAlgorithm";
public const string UnsupportedLastTransform = "UnsupportedLastTransform";
public const string UnsupportedNodeTypeInReader = "UnsupportedNodeTypeInReader";
public const string UnsupportedTransformAlgorithm = "UnsupportedTransformAlgorithm";
public const string UserNameAuthenticationFailed = "UserNameAuthenticationFailed";
public const string ValueMustBeOf2Types = "ValueMustBeOf2Types";
public const string ValueMustBeOne = "ValueMustBeOne";
public const string ValueMustBeZero = "ValueMustBeZero";
public const string WebPageDescription = "WebPageDescription";
public const string WebPageText = "WebPageText";
public const string X509CertStoreLocationNotValid = "X509CertStoreLocationNotValid";
public const string X509ChainBuildFail = "X509ChainBuildFail";
public const string X509FindValueMismatch = "X509FindValueMismatch";
public const string X509FindValueMismatchMulti = "X509FindValueMismatchMulti";
public const string X509InvalidUsageTime = "X509InvalidUsageTime";
public const string X509IsInUntrustedStore = "X509IsInUntrustedStore";
public const string X509IsNotInTrustedStore = "X509IsNotInTrustedStore";
public const string XmlTokenBufferIsEmpty = "XmlTokenBufferIsEmpty";
	}
//}
