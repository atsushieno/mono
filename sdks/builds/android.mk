...
$(eval $(call AndroidSDKProvisioningTemplate,platform-tools_r$(ANDROID_BUILD_TOOLS_DIR)-darwin,platform-tools))
...
$(eval $(call AndroidSDKProvisioningTemplate,platform-tools_r$(ANDROID_BUILD_TOOLS_DIR)-linux,platform-tools))
